declare namespace LX {
  namespace Music {
    ...
    interface MusicInfoMeta_media extends MusicInfoMetaBase {
      filePath: string
      ext: string
      connectionId: string
      connectionName: string
      connectionType: 'smb' | 'webdav' | 'local' | 'onedrive'
      type?: string
      versionToken?: string
    }
    ...
    interface MusicInfoMedia extends MusicInfoBase<'media'> {
      meta: MusicInfoMeta_media
    }
    ...
    type MusicInfo = MusicInfoOnline | MusicInfoLocal | MusicInfoMedia
