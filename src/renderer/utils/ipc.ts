...
export const getMediaConnections = async() => {
  return rendererInvoke<MediaConnectionInfo[]>(WIN_MAIN_RENDERER_EVENT_NAME.media_connection_list)
}
export const saveMediaConnection = async(connection: any) => {
  return rendererInvoke<any, MediaConnectionInfo>(WIN_MAIN_RENDERER_EVENT_NAME.media_connection_save, connection)
}
export const removeMediaConnection = async(id: string) => {
  return rendererInvoke<string>(WIN_MAIN_RENDERER_EVENT_NAME.media_connection_remove, id)
}
...
export const getMediaLibraryListByConnection = async(connectionId: string) => {
  return rendererInvoke<string, LX.Music.MusicInfo[]>(WIN_MAIN_RENDERER_EVENT_NAME.media_library_list_by_connection, connectionId)
}
export const getMediaLibraryPlayUrl = async(id: string) => {
  return rendererInvoke<string, string>(WIN_MAIN_RENDERER_EVENT_NAME.media_library_get_play_url, id)
}
