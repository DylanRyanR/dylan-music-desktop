...
import {
  getMusicUrl as getMediaMusicUrl,
  getPicUrl as getMediaPicUrl,
  getLyricInfo as getMediaLyricInfo,
} from './media'
...
export const getMusicUrl = async({
  ...
  } else if (musicInfo.source == 'media') {
    return getMediaMusicUrl({ musicInfo: musicInfo as any, isRefresh, onToggleSource, allowToggleSource })
  } else {
...
export const getPicPath = async({
  ...
  if ('progress' in musicInfo) {
    ...
    return getMediaPicUrl({ musicInfo: musicInfo as any, isRefresh, listId, onToggleSource })
  } else {
...
export const getLyricInfo = async({
  ...
  if ('progress' in musicInfo) {
    ...
    return getMediaLyricInfo({ musicInfo: musicInfo as any, isRefresh, onToggleSource })
  } else {
